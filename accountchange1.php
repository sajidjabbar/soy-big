...
<!-- Stylesheet -->
<link rel="stylesheet" href="css/accountchange1.css">
                    ...
                    <form>
                        ...
                        <div class="name">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Selina">
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Last name</label>
                                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="kyle">
                            </div>
                        </div>
                        <div class="name">

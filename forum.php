        ...
        <div class="container-fluid">
            <div class="banner_content">
                <div class="row">
                    <div class="col-lg-8 ">
                        <div class="banner">
                            <h2 class="title wow animate__animated animate__fadeInDown">Our Forum Where You Can Find
                                <br />
                                Discussion On Any Category
                            </h2>
                ...
                <div class="forum_posts">
                    ...
                    <div class="post_box shadow_box">
                        ...
                        <a href="#">
                            <div class="user-details">
                                <div class="img_box">
                                    <figure><img src="img/user3.png" class="img-fluid"></figure>
                                </div>
                                <div class="details">
                                    <h5 class="name">Terri Wilkes</h5>
                                    <p class="times_ago">Posted 3 Hours Ago</p>
                    ...
                    <div class="post_box shadow_box">
                        ...
                        <a href="#">
                            <div class="user-details">
                                <div class="img_box">
                                    <figure><img src="img/user4.png" class="img-fluid"></figure>
                                </div>
                                <div class="details">
                                    <h5 class="name">Terri Wilkes</h5>
                                    <p class="times_ago">Posted 3 Hours Ago</p>
                    ...
                    <div class="post_box shadow_box">
                        ...
                        <a href="#">
                            <div class="user-details">
                                <div class="img_box">
                                    <figure><img src="img/user5.png" class="img-fluid"></figure>
                                </div>
                                <div class="details">
                                    <h5 class="name">Terri Wilkes</h5>
                                    <p class="times_ago">Posted 3 Hours Ago</p>

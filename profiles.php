        ...
        <div class="row">
            <div class="col-lg-3 px-0">
                <div class="profile-details">
                    ...
                    <a href="editprofile.php" class="btn"> <img src="img/Icon-material.png" alt=""> Edit Profile</a>
                </div>
            </div>
            <div class="col-lg-9">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                aria-controls="home" aria-selected="true">Forum</a>
                        </li>
                        <li class="nav-item">
                                ...
                                <div class="post_box shadow_box">
                                    ...
                                    <a href="single-post.php">
                                        <div class="user-details">
                                            <div class="img_box">
                                                <figure><img src="img/Ellipse25.png" class="img-fluid"></figure>
                                            </div>
                                            <div class="details">
                            ...
                            <div class="forum_posts">
                                <div class="post_box shadow_box">
                                    ...
                                    <a href="single-post.php">
                                        <div class="user-details">
                                            <div class="img_box">
                                                <figure><img src="img/Ellipse-28.png" class="img-fluid"></figure>
                                            </div>
                                            <div class="details">
                                                <h5 class="name">Selina Kyle</h5>
                                                <p class="times_ago">Posted 3 Hours Ago</p>

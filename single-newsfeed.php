...
<!-- Stylesheet -->
<link rel="stylesheet" href="css/single-newsfeed.css">
<!-- Stylesheet -->
            ...
            <div class="col-lg-9">
                ...
                <div class="write-post shadow_box pb-2">
                    <div class="write_box">
                        ...
                        <div class="form-group">
                            <input type="text" placeholder="Post a Comment" class="form-control">
                ...
                <div class="comments_box shadow_box">
                    <div class="head">
                        <h4>Comments <span class="count">40</span></h4>
                    </div>
                    <div class="all_comments">
                        <div class="comments_and_replay">
                            <div class="commentsDv" id="frstComment">
                                <div class="user-img">
                                    <figure><img src="img/user1.png" class="img-fluid"></figure>
                                </div>
                                <div class="post-text">
                            ...
                            <div class="commentsDv replyDv">
                                <div class="user-img">
                                    <figure><img src="img/user8.png" class="img-fluid"></figure>
                                </div>
                                <div class="post-text">
                                    <div class="details">
                                        <h5 class="name">Terri Wilkes</h5>
                            ...
                            <div class="commentsDv replyDv">
                                <div class="user-img">
                                    <figure><img src="img/user9.png" class="img-fluid"></figure>
                                </div>
                                <div class="post-text">
                                    <div class="details">
                                        <h5 class="name">Terri Wilkes</h5>
                        ...
                        <div class="comments_and_replay">
                            <div class="commentsDv">
                                <div class="user-img">
                                    <figure><img src="img/user7.png" class="img-fluid"></figure>
                                </div>
                                <div class="post-text">
                                    <div class="details">
                                        <h5 class="name">Bella Khan</h5>
                                    </div>
                                    <p>
                                        Venenatis Urna Cursus Eget Nunc Scelerisque Viverra Mauris Lorem Ipsum Dolor Sit
                                        Amet,
                    ...
                    <div class="bottom-bar">
                        ...
                        <a href="#frstComment" class="go-to-top">Go Back To Top</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3">
